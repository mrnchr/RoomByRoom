...
namespace RoomByRoom
{
  public sealed class Engine : MonoBehaviour
  {
    ...
    [FormerlySerializedAs("_gameSaveSo")] [FormerlySerializedAs("_gameData"),FormerlySerializedAs("_initializeData"),SerializeField] private ProgressDataSO _progressDataSo;
    ...
    private IGameSaveService _gameSaveSvc;
    private GlobalState _globalState;

    [Inject]
    public void Construct(PlayerConfigurationSO config, IGameSaveService gameSaveSvc, ProgressData progressData)
    {
...
#if UNITY_EDITOR
      _sceneInfo.CurrentState = _globalState;
      _sceneInfo.CurrentSave = _progressData;
    ...
    private void Start()
    {
      ...
      var blockingSvc = new BlockingService(_globalState);
      ...
      _mediator.SetServices(new TurnWindowService(_message), _equipSvc, sceneSvc);
...
#endif
        .Inject(_sceneInfo, _progressData, _prefabSvc, _config,
                _gameSaveSvc, _progressDataSo, _globalState, attackSvc, _enemyData, charSvc, _playerData, blockingSvc,
