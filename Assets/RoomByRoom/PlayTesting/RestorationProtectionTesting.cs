...
namespace RoomByRoom.PlayTesting
{
    public class RestorationProtectionTest
    {
        ...
        public IEnumerator WhenPlayerAttack_AndHitEnemy_ThenHisProtectionShouldBeRestoredInAWhile()
        {
            ...
            // Arrange
            GameObject engObject = new GameObject("Engine (test)");
            RestoreProtectionEngine eng = engObject.AddComponent<RestoreProtectionEngine>();

            yield return new WaitWhile(() => eng.World == null || exit);
            eng.StartCoroutine(WaitToStopTest());
        
            GameObject roomObj = (GameObject) Object.Instantiate(Resources.Load("StartRoom Variant"));
            RoomView roomView = roomObj.GetComponent<RoomView>();
        
            int player = eng.World.NewEntity();
            GameObject playerObj = (GameObject) Object.Instantiate(Resources.Load("Player Variant"));
            ...
            GameObject enemyObj = (GameObject) Object.Instantiate(Resources.Load("HumanoidEnemy Variant"));
            HumanoidView enemyView = enemyObj.GetComponent<HumanoidView>();
            ...
            GameObject weaponObj = (GameObject) Object.Instantiate(Resources.Load("Axe1 Variant"));
            WeaponView weaponView = weaponObj.GetComponent<WeaponView>();
